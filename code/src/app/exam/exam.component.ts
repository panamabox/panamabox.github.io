...
export class ExamComponent implements OnInit{
    private questions1: any[];
    private questions2: any[];
    private questions3: any[];
    private questions4: any[];
    private questions5: any[];
    ...
    selectRandomQuestions(questions: any[], count: number) {
        var dictionary = {
            500: true
        };
