...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_13__result_result_component__ = __webpack_require__("../../../../../src/app/result/result.component.ts");
...
AppModule = __decorate([
    Object(__WEBPACK_IMPORTED_MODULE_1__angular_core__["M" /* NgModule */])({
        ...
        imports: [
            ...
            __WEBPACK_IMPORTED_MODULE_2__angular_router__["c" /* RouterModule */].forRoot(__WEBPACK_IMPORTED_MODULE_4__app_routing__["a" /* AppRoutes */]),
...
var AppRoutes = [
    ...
    {
        path: 'result',
        component: __WEBPACK_IMPORTED_MODULE_6__result_result_component__["a" /* ResultComponent */]
    }
];
...
var ExamComponent = (function () {
    function ExamComponent(renderer, element, router) {
    ...
    ExamComponent.prototype.nextClick = function () {
        ...
        if (this.currentIndex >= this.examQuestions.length) {
            this.router.navigate(["/result"], {
                queryParams: {
                    result: this.correctAnswres,
                    questions: this.examQuestions.length
                }
            });
        }
    ...
    ExamComponent.prototype.shuffle = function () {
        var currentIndex = this.examQuestions.length, temporaryValue, randomIndex;
        ...
        while (0 !== currentIndex) {
            ...
            temporaryValue = this.examQuestions[currentIndex];
            this.examQuestions[currentIndex] = this.examQuestions[randomIndex];
            this.examQuestions[randomIndex] = temporaryValue;
        }
    };
    ExamComponent.prototype.generateExamQuestions = function () {
        //10 tarea 1
        this.selectRandomQuestions(this.questions1, 10);
        //3 tarea 2
        this.selectRandomQuestions(this.questions2, 3);
        //2 tarea 3
        this.selectRandomQuestions(this.questions3, 2);
        //3 tarea 4
        this.selectRandomQuestions(this.questions4, 3);
        //7 tarea 5
        this.selectRandomQuestions(this.questions5, 7);
        //15 of 25
    };
    ExamComponent.prototype.selectRandomQuestions = function (questions, count) {
        var dictionary = {
            500: true
        };
        for (var i = 0; i < count; i++) {
            var random = 500;
            while (dictionary[random]) {
                var random = this.randomIntFromInterval(0, questions.length - 1);
            }
            dictionary[random] = true;
            this.examQuestions.push(questions[random]);
        }
    };
    ExamComponent.prototype.randomIntFromInterval = function (min, max) {
        return Math.floor(Math.random() * (max - min + 1) + min);
    };
    ExamComponent.prototype.reset = function () {
        this.currentIndex = 0;
        this.correctAnswres = 0;
        this.examQuestions = [];
    };
...
ExamComponent = __decorate([
    ...
    __metadata("design:paramtypes", [typeof (_a = typeof __WEBPACK_IMPORTED_MODULE_0__angular_core__["_1" /* Renderer */] !== "undefined" && __WEBPACK_IMPORTED_MODULE_0__angular_core__["_1" /* Renderer */]) === "function" && _a || Object, typeof (_b = typeof __WEBPACK_IMPORTED_MODULE_0__angular_core__["v" /* ElementRef */] !== "undefined" && __WEBPACK_IMPORTED_MODULE_0__angular_core__["v" /* ElementRef */]) === "function" && _b || Object, typeof (_c = typeof __WEBPACK_IMPORTED_MODULE_1__angular_router__["b" /* Router */] !== "undefined" && __WEBPACK_IMPORTED_MODULE_1__angular_router__["b" /* Router */]) === "function" && _c || Object])
], ExamComponent);
...
var ResultComponent = (function () {
    function ResultComponent(route, renderer, element) {
        this.route = route;
        this.renderer = renderer;
        this.element = element;
        this.nativeElement = element.nativeElement;
    ...
    ResultComponent.prototype.ngOnInit = function () {
        ...
        this.sub = this.route.queryParams.subscribe(function (params) {
            ...
            _this.questions = params['questions'];
            var q = _this.element.nativeElement;
...
ResultComponent = __decorate([
    ...
    __metadata("design:paramtypes", [typeof (_a = typeof __WEBPACK_IMPORTED_MODULE_1__angular_router__["a" /* ActivatedRoute */] !== "undefined" && __WEBPACK_IMPORTED_MODULE_1__angular_router__["a" /* ActivatedRoute */]) === "function" && _a || Object, typeof (_b = typeof __WEBPACK_IMPORTED_MODULE_0__angular_core__["_1" /* Renderer */] !== "undefined" && __WEBPACK_IMPORTED_MODULE_0__angular_core__["_1" /* Renderer */]) === "function" && _b || Object, typeof (_c = typeof __WEBPACK_IMPORTED_MODULE_0__angular_core__["v" /* ElementRef */] !== "undefined" && __WEBPACK_IMPORTED_MODULE_0__angular_core__["v" /* ElementRef */]) === "function" && _c || Object])
], ResultComponent);
